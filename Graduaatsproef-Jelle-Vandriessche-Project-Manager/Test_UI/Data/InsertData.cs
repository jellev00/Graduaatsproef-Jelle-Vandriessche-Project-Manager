...
namespace Test_UI.Data
{
    public class InsertData
    {
        ...
        public List<Project> Projects()
        {
            ...
            Project project1 = new Project(1, "Project A", "Description for Project A");
            Project project2 = new Project(2, "Project B", "Description for Project B");
        ...
        public List<UserTasks> UserTasks()
        {
            ...
            UserTasks userTasks1 = new UserTasks(1, "Task 1 for Jelle Vandriessche");
            UserTasks userTasks2 = new UserTasks(1, "Task 2 for Jelle Vandriessche");
            UserTasks userTasks3 = new UserTasks(2, "Task 1 for John Doe");
        ...
        public List<ProjectTasks> ProjectTasks()
        {
            ...
            ProjectTasks projectTasks1 = new ProjectTasks(1, "Task 1 for Project A");
            ProjectTasks projectTasks2 = new ProjectTasks(1, "Task 2 for Project A");
            ProjectTasks projectTasks3 = new ProjectTasks(2, "Task 1 for Project B");
